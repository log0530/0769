...
<meta name="description" content="0769Pool">
<meta name="keywords" content="0769Pool">
...
function showPageHeader()
{
	...
	$nextpayment = date('H:i:s T', $mining->last_payout+YAAMP_PAYMENTS_FREQ);
	$eta = ($mining->last_payout+YAAMP_PAYMENTS_FREQ) - time();
	$eta_mn = ''.round($eta / 60).' M';
    $nowtime =date("H:i:s T");
	echo '<span id="nextpayout" style="font-size: .8em;" title="'.$eta_mn.'">Next Payout: '.$nextpayment.'<b style="color:#ff0000;font-size: 16px;font-weight:bold;">('.$eta_mn.')</b></span>';
