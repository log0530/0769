...
foreach($coins as $coin)
{
	...
	if (!empty($coin->symbol2)) $version .= " ({$coin->symbol2})";
		...
		if($coin->auxpow) echo "<td><b><a href='/site/coin?id=$coin->id'><span style='color: red;'>$coin->name ($coin->symbol)</span></a></b>
		<br><span style='font-size: .8em'>$version</span></td>";
	else echo "<td><b><a href='/site/coin?id=$coin->id'>$coin->name ($coin->symbol)</a></b>
		<br><span style='font-size: .8em'>$version</span></td>";
